...
test.describe('Create Campaign', () => {
   ...
   */
  test('CAMP-012: Verify Create Campaign Page Displays Required Elements',
    async ({ page }) => {


      const createCampaign =
        new CreateCampaignPage(page);
   ...
   */
  test('CAMP-013: Verify Create Campaign Form Displays All Available Fields',
    async ({ page }) => {
   ...
   */
  test('CAMP-014: Verify User Can Create Campaign With Valid Data',
    async ({ page }) => {
   ...
   */
  test('CAMP-015: Verify Required Campaign Fields Are Validated',
    async ({ page }) => {
   ...
   */
  test('CAMP-023: Verify Newly Created Campaign Appears In Campaign List',
    async ({ page }) => {


      const campaignName =
        'Grid Verification Campaign';
   ...
   */
  test('CAMP-032: Verify Campaign Creation Returns User To Campaign List',
    async ({ page }) => {
